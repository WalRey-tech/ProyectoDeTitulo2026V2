...
# =============================================================================
# 2. MOTOR DE CLASIFICACIÓN (Actualizado sin Técnicos)
# =============================================================================
def clasificar_grado(nombre_carrera):
    ...
    # Regla 2: 'Ejecución' si contiene «ejecu»
        ...
        return 'Ejecución'
    # Regla 3: 'Informática' en el resto de los casos (Ingenierías generales)
    else:
        return 'Informática'
...
def main():
    ...
    # Por si se coló alguna carrera técnica en el config.py, 
    # esto la detecta y la elimina para no contaminar el modelo.
    filtro_tecnicos = df['carrera'].str.lower().str.contains('técnico|tecnico|analista', na=False)
    tecnicos_encontrados = filtro_tecnicos.sum()
    
    if tecnicos_encontrados > 0:
        print(f"Se detectaron {tecnicos_encontrados} perfiles técnicos o analistas. Eliminándolos del dataset por solicitud del profesor...")
    ...
    print("\n Distribución final del dataset (Solo Ingenierías):")
