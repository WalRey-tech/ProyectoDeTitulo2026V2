...
# =============================================================================
# Importación de Modelos (El Benchmark - Ajustado)
# =============================================================================
...
def main():
    ...
    # =============================================================================
    print("Aplicando SMOTE: Generando datos sintéticos para balancear la clase 'Ejecución'...")
    ...
    # =============================================================================
    # MODELOS CONFIGURADOS (Removido QDA y reenumerados correlativamente del 1 al 11)
    # =============================================================================
    modelos = {
        ...
        "4. Regresión Logística": LogisticRegression(C=5, max_iter=2000, random_state=42),
    ...
    print("\nRESULTADO FINAL")
    print(f"El modelo con mejor rendimiento predictivo fue '{mejor['Modelo']}' con un {mejor['Accuracy (%)']}%.")
